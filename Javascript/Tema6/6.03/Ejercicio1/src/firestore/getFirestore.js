...
import { onSnapshot, updateDoc, query, where, or, deleteDoc } from "https://www.gstatic.com/firebasejs/11.1.0/firebase-firestore.js";
...
export { db, addDoc, collection, writeBatch, doc, getDocs, onSnapshot, updateDoc, query, where, or, deleteDoc };