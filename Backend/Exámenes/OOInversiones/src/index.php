...
use App\Controller\FondoIndexadoController;
...
// MIS RUTAS DAVID GARCÍA VALERO

// Ruta a la creación de una empresa en /formulario

$router->get('/formulario',function (){
    include_once "app/View/formulario.php";
});

// POST para la creación de una empresa en /formulario

$router->post('/formulario',[FondoIndexadoController::class,'guardar']);

// DELETE de un inversor por su id (email)

$router->delete('/inversor/{id}',[InversorController::class,'destroy']);
